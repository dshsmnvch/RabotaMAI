                  ...
                  >
                    ...
                    <div className='flex flex-col'>
                      ...
                      <textarea
                        ...
                        cols={6}
                        {...register("about", {
                          required: "Расскажите о вашей компании!",
                        })}
      ...
      <div className=''>
        ...
        <div className='w-full flex flex-col md:flex-row justify-start md:justify-between mt-4 md:mt-8 text-sm'>
          <p className='flex gap-1 items-center   px-3 py-1 text-slate-600 rounded-full'>
            <HiLocationMarker /> {info?.location ?? "Расположение не указано"}
          </p>
          <p className='flex gap-1 items-center   px-3 py-1 text-slate-600 rounded-full'>
            <AiOutlineMail /> {info?.email ?? "Email не указан"}
          </p>
          <p className='flex gap-1 items-center   px-3 py-1 text-slate-600 rounded-full'>
            <FiPhoneCall /> {info?.contact ?? "Контакты не указаны"}
          </p>

          <div className='flex flex-col items-center mt-10 md:mt-0'>
            <span className='text-xl'>{info?.jobPosts?.length}</span>
            <p className='text-blue-600 '>Вакансия</p>
          </div>
        </div>
      </div>

      <div className='w-full mt-20 flex flex-col gap-2'>
        <p>Опубликовано вакансий</p>
