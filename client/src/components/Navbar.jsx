                ...
                {({ active }) => (
                  ...
                  >
                    <CgProfile
                      ...
                      aria-hidden='true'
                    />
                    {user?.accountType ? "Профиль пользователя" : "Профиль компании"}
                  </Link>
                )}
              </Menu.Item>
        ...
        <nav className='container mx-auto flex items-center justify-between p-5'>
          <div>
            <Link to='/' className='text-blue-600 font-bold text-xl'>
              MAI<span className='text-[#1677cccb]'>Работа</span>
            </Link>
          </div>

          <ul className='hidden lg:flex gap-10 text-base'>
            <li>
              <Link to='/'>Найти работу</Link>
            </li>
            <li>
            ...
            <li>
              ...
              >
                {user?.accountType === "seeker" ? "Отклики" : "Опубликовать вакансию"}
              </Link>
            </li>
            <li>
